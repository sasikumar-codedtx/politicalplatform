...
class ContentService {
  ...
  static final List<ManifestoPlan> _tvkPlans = [
    ManifestoPlan(id: 'p1', year: '2026', title: 'Clean Water for Villages', description: 'Provide purified drinking water to 500 villages using solar-powered filtration. Reduces water-borne diseases and saves women\'s time on water collection.', timeline: 'Jan 2026 – Sep 2026', budget: '₹500 Crore', category: 'Infrastructure'),
    ManifestoPlan(id: 'p2', year: '2026', title: 'Digital Classrooms Expansion', description: 'Equip 1000 schools with smart classrooms and high-speed internet connectivity to bridge the digital divide in rural Tamil Nadu.', timeline: 'Mar 2026 – Dec 2026', budget: '₹800 Crore', category: 'Education'),
    ManifestoPlan(id: 'p3', year: '2027', title: 'Youth Employment Scheme', description: 'Create 5 lakh skilled jobs for Tamil youth through industry partnerships and government-funded skill training centres in every district.', timeline: 'Jan 2027 – Dec 2027', budget: '₹1200 Crore', category: 'Employment'),
    ManifestoPlan(id: 'p4', year: '2027', title: 'Farmer Income Guarantee', description: 'Guarantee minimum income of ₹15,000 per month to all registered farmers through direct benefit transfer and crop insurance reform.', timeline: 'Apr 2027 – Mar 2028', budget: '₹2000 Crore', category: 'Agriculture'),
    ManifestoPlan(id: 'p5', year: '2028', title: 'Women Safety Network', description: 'Deploy 10,000 women police officers across Tamil Nadu with dedicated fast-track courts for crimes against women.', timeline: 'Jan 2028 – Dec 2028', budget: '₹600 Crore', category: 'Safety'),
  ];
